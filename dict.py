...
#         total+=float(i['salary'].replace("$", ""))
# print(total)

# for i in data:
#     if i['full_name'][0]=="K":
#         i['salary']=str(float(i['salary'].replace("$", ""))*2)
#         print(i["full_name"],i["salary"])

# for i in data:
#     i["FIO"] = i.pop("full_name")
#     print(i)

# n=[i for i in data if "Senior" not in i['position'] and "Junior" not in i['position']]
# print(n)


# count=0
# for i in data:
#     if i['position'].count('Assistant'):
#      count+=1
# print(count)
